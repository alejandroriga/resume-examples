/**
 * seed-survey-recruiters.js
 * Seeds the "Recruiters" internal survey into the database.
 *
 * Usage: node seed-survey-recruiters.js
 */
const db = require('./db');

const SURVEY_ID = 'recruiters-2026';
const SURVEY_TITLE = 'Toptal Resume — Internal Survey: Recruiters';
const SURVEY_DESC = "As a recruiter at Toptal, you're the first filter candidates encounter. Your perspective directly shapes Toptal Resume — our service that helps talent build the best possible resumes. Your insights will become data-backed guidance used by thousands of candidates.";
...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'E', label: 'Not applicable — I shortlist but don\'t make final decisions' },
    ]
  },
  ...
  // ─── Hiring Impact ───
  {
    ...
    text: "How much does a well-tailored resume improve a candidate's chances of getting shortlisted?",
    type: 'single',
    options: [
  ...
  // ─── Expert Advice (Open-Ended) ───
  {
    ...
    maxLength: 2000,
    permission: "I give permission to quote my response with my first name and title on Toptal Resume's public pages."
  },
];
